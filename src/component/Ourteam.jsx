    ...
    return (
        <section className="w-full bg-white py-16 px-6">
            ...
            <div className='max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 place-items-center gap-6 mt-4'>
                ...
                {/*image 5*/}
                <div className="hover:transition-transform duration-300 ease-in-out hover:scale-110">
                    <img className="w-60 h-72 md:w-80 md:h-96 object-cover rounded-lg" src={OurTeamImg4} alt="image"/>
                </div>

                {/*image 6*/}
                <div className="hover:transition-transform duration-300 ease-in-out hover:scale-110">
                    <img className="w-60 h-72 md:w-80 md:h-96 object-cover rounded-lg md:mr-10" src={OurTeamImg6} alt="image"/>
                </div>
            </div>
