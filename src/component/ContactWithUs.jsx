        ...
        <section>
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 z-10 flex flex-col md:flex-row justify-center md:justify-around items-center gap-5 md:gap-0 mr-8 md:mr-0">
                    ...
                    <button className="px-6 py-3 rounded-md bg-orange-600 text-white hover:text-orange-600 hover:bg-white hover:border-2 hover:border-orange-600 cursor-pointer" data-aos="fade-right"
