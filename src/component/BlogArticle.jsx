...
const BlogArticle = () => {
    return (
        <>
            <section className="bg-white max-w-6xl mx-auto w-full py-16 px-10" data-aos="fade-up">
                {/*heading content*/}
                <div className="flex flex-col md:flex-row justify-between items-center md:items-end space-y-4 " data-aos="fade-down">
                    {/*left section*/}
                    <div className="flex flex-col" data-aos="zoom-in">
                        <h2 className="text-orange-500 font-semibold mb-2 text-xl text-center md:text-left" data-aos="fade-up"
                            data-aos-delay="200">Blog & Article</h2>
                        <h1 className="text-2xl md:text-4xl lg:text-4xl font-semibold text-[#242254] text-center md:text-left leading-snug" data-aos="fade-right"
                            data-aos-duration="1000">
                            Get The <span className="text-orange-500">Latest</span> Our News
                        </h1>
                    </div>
                    {/*right section*/}
                    <div className="flex gap-3" data-aos="zoom-in-left">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 place-items-center mt-20">
                    {/*Blog 1*/}
                    <div className="w-80 shadow-lg rounded-md" data-aos="flip-left">
                        ...
                        <div className="px-4 py-6 space-y-2">
                            ...
                            <h1 className="text-[#242254] text-lg md:text-xl font-bold">
                                Optimizing Supply Chain <br className="hidden md:block" />Efficiency
                            </h1>
                            <button className="flex text-orange-500 font-semibold hover:underline underline-offset-2 cursor-pointer" data-aos="zoom-in">
                                Read More<GoArrowUpRight className="mt-1" />
                            </button>
                        </div>
                    </div>

                    {/*Blog 2*/}
                    <div className="w-80 shadow-lg rounded-md" data-aos="flip-up">
                        ...
                        <div className="px-4 py-6 space-y-2">
                            ...
                            <h1 className="text-[#242254] text-lg md:text-xl font-bold">
                                navigating <br className="hidden md:block" />International customer
                            </h1>
                            <button className="flex text-orange-500 font-semibold hover:underline underline-offset-2 cursor-pointer" data-aos="zoom-in">
                                Read More<GoArrowUpRight className="mt-1" />
                            </button>
                    ...
                    {/*Blog 3*/}
                    <div className="w-80 shadow-lg rounded-md" data-aos="flip-right">
                        ...
                        <div className="px-4 py-6 space-y-2">
                            ...
                            <h1 className="text-[#242254] text-lg md:text-xl font-bold">
                                Sustainable Logistic Building <br className="hidden md:block" /> a Greener
                            </h1>
                            <button className="flex text-orange-500 font-semibold hover:underline underline-offset-2 cursor-pointer" data-aos="zoom-in">
                                Read More<GoArrowUpRight className="mt-1" />
                            </button>
