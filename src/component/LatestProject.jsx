    ...
    return (
        <>
            <section className="bg-white w-full py-16 px-6">
                <h2 className="text-orange-500 font-semibold mb-2 text-xl text-center" data-aos="fade-up">Latest Project</h2>
                <h1 className="text-2xl md:text-4xl lg:text-4xl font-semibold text-[#242254] text-center leading-snug" data-aos="fade-up">Explore Our <span className="text-orange-500"> Portfolio </span>of Recent<br /> Achievements</h1>
                ...
                <div className="flex justify-center mt-10">
                    <button className="px-6 py-3 rounded-md bg-orange-500 text-white hover:bg-white hover:text-orange-500 hover:border-2 border-transparent hover:border-orange-500 cursor-pointer transition-all duration-300 ease-in-out">View All Projecct</button>
                </div>
            </section>
